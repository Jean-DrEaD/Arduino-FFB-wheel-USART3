...
static void stmEncPoll() {
  ...
  while (Serial1.available() > 0) {
    ...
    if (idx >= sizeof(StmEncFrame)) {
      ...
      // STM32 envia get_x_TotalCount() = contagem cumulativa do encoder (raw counts)
      // ROTATION_MAX = CPR/360*ROTATION_DEG = 12288 counts para 1080 graus
      // Valores raw ja estao na mesma unidade que ROTATION_MAX, usar direto

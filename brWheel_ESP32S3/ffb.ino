...
#ifndef ESP32
  #include "USBCore.h"  // AVR/Pro Micro only
#endif
#include <stdint.h>
#include "debug.h"
...
#else
// ESP32-S3: FfbOnUsbData é chamado por WheelFFBDevice::_onSetReport() em HID_Wheel_ESP32.h
// Não há callback USB a registrar — apenas inicializa o driver e limpa os efeitos.
void FfbInit(void) {
  ffb = &ffb_drivers[0];
  FreeAllEffects();
}
void FfbSetDriver(uint8_t id) { FfbInit(); }  // compatibilidade
#endif

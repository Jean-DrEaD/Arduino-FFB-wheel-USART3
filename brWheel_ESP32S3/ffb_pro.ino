...
#else
  // ESP32: sem encoder quadratura local — posição vem do GD32 via UART
...
#ifndef ESP32
// Calibração mecânica via encoder local (quadratura/AS5600).
// No ESP32-S3 não há encoder local — alinhamento é feito pelo GD32 via UART.
...
#else
// ESP32: stub — alinhamento via GD32 (auto-center em brWheel_ESP32S3.ino)
void BRFFB::calibrate() {
  CONFIG_SERIAL.println("ESP32: calibrate() N/A — use GD32 alignment");
}
#endif
